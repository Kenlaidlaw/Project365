...
Each day I will load the project progress onto Github.  Along with this I will be completing the design elements, this New Years resolution is purely focused on the process of making the app work rather than how it looks. - having attempted this I am now including the whole process as some of it you just can't do very well until you understand the bigger picture, good lesson to learn.
...
Day 5 - revisited a tutorial on creating a task list and used it on practice page. - Need to decide on framework to use, thinking bulma
Day 6 - did a review of Bulma and tailwind CSS and played about with them. leaning towards Tailwind.
Day 7 - started to work on a design in figma to build the app upon.